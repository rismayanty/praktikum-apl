...
void bubbleSortNamaDescending(member arr[], int n) {
    for (int i = 0; i < n - 1; i++) {
        bool swapped = false;
...
void insertionSortIdAscending(member arr[], int n) {
    for (int i = 1; i < n; i++) {
        member key = arr[i];
        int j = i - 1;
...
int partitionHarga(member arr[], int low, int high) {
    int pivot = arr[high].detail.harga;
    int i = low - 1;
    for (int j = low; j < high; j++) {
        if (arr[j].detail.harga < pivot) {
            i++;
            swap(arr[i], arr[j]);
        }
    }
...
void quickSortHarga(member arr[], int low, int high) {
    if (low < high) {
...
void bacasemuadata(member members[], int jumlahmember) {
    ...
    cout << "      SORTING       " << endl;
    cout << "===================" << endl;
    cout << "  1. Nama (Z -> A) [Bubble Sort]    " << endl;
    cout << "  2. ID (1 -> 100) [Insertion Sort] " << endl;
    cout << "  3. Harga (Termurah) [Quick Sort]  " << endl;
    ...
    if (opsi == 1) {
        bubbleSortNamaDescending(temp, jumlahmember);
        cout << "\nData diurutkan: Nama (Z -> A) - Bubble Sort" << endl;
    } else if (opsi == 2) {
        insertionSortIdAscending(temp, jumlahmember);
        cout << "\nData diurutkan: ID (1 -> 100) - Insertion Sort" << endl;
    } else if (opsi == 3) {
        quickSortHarga(temp, 0, jumlahmember - 1);
        cout << "\nData diurutkan: Harga (Termurah) - Quick Sort" << endl;
    } else {
...
void searchingMember(member members[], int jumlahmember) {
    ...
    if (opsi == 1) {
        ...
        if (hasil != -1) {
            ...
            cout << "\n[!] ID " << cariID << " tidak ditemukan." << endl;
        }
    } else if (opsi == 2) {
        string cariNama;
        ...
        if (hasil != -1) {
            ...
            cout << "\nNama \"" << cariNama << "\" tidak ditemukan." << endl;
        }
    } else {
...
void menuAdmin(member members[], int &jumlahmember, string userLogin) {
    ...
    do {
        cout << endl;
        cout << "============================================" << endl;
        cout << "          login sebagai: " << userLogin << " (admin)" << endl;
        ...
        if (pilihan < 1 || pilihan > 6) {
            cout << "PILIHAN TIDAK VALID! hanya 1-6." << endl;
            continue;
        }
...
void menuMember(member members[], int &jumlahmember, string userLogin) {
    ...
    do {
        cout << endl;
        cout << "============================================" << endl;
        cout << "          login sebagai: " << userLogin << " (member)" << endl;
        cout << "          mau ngapain nih???                " << endl;
        cout << "============================================" << endl;
